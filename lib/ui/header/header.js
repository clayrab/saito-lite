...
module.exports = HomeHeader = {
    ...
    render(app) {
      console.log("HEADER RENDER")
        ...
        let responders = [];
        app.modules.respondTo("header-dropdown").forEach((responderAPI) => {
          console.log("rsponsderAPI");
          console.log(responderAPI);
          responders.push(responderAPI);
        });
        // let ddmods = [];
        ...
        header.innerHTML = HomeHeaderTemplate(responders);
        header.classList.add('header-home');

        header.append(
            elParser(HeaderDropdownTemplate(responders))
        );
        header.append(
